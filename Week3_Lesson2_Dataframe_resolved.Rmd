...
```{r}
names <- c("Maria", "Lucas", "Clara", "Sara")
```
...
```{r}
fruits <- c("banana", "maçã", "laranja", "uva", "mamão")
```
...
Make sure to mark this activity as complete in Coursera.he